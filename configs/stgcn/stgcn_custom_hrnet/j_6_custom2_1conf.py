...
# ann_file = 'data_generate/datasets_action_6_10fps/custom_hrnet_11kp_1conf.pkl'
ann_file = 'data_generate/datasets_action_6_10fps_test/custom_hrnet_11kp_1conf.pkl'
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/stgcn_custom_6_custom2_1conf/'

# nohup bash tools/dist_train.sh configs/stgcn/stgcn_custom_hrnet/j_6_custom2_1conf.py 6 --validate --test-last --test-best > nohup.log 2>&1 &
# bash tools/dist_test.sh configs/stgcn/stgcn_custom_hrnet/j_6_custom2_1conf.py work_dirs/stgcn_custom_6_custom2_1conf/epoch_20.pth 6 --eval top_k_accuracy --out result.pkl
