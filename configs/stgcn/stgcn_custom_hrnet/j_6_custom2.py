...
ann_file = 'data_generate/datasets_action_6_10fps/custom_hrnet_11kp.pkl'

train_pipeline = [
    dict(type='PreNormalize2D'),
    dict(type='GenSkeFeat', dataset='custom2', feats=['j']),
    dict(type='UniformSample', clip_len=100, seed=300),
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/stgcn_custom_6_custom2_test/'

# nohup bash tools/dist_train.sh configs/stgcn/stgcn_custom_hrnet/j_6_custom2.py 6 --validate --test-last --test-best > nohup.log 2>&1 &
