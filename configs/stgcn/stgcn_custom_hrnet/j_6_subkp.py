...
ann_file = 'data_generate/datasets_action_6/custom_hrnet_subkp.pkl'
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/stgcn_custom_6_subkp_1/'

# nohup bash tools/dist_train.sh configs/stgcn/stgcn_custom_hrnet/j_6_subkp.py 6 --validate --test-last --test-best > nohup.log 2>&1 &
